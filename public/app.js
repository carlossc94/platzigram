...
var el = yo(_templateObject, translate.mensaje('language'), lang.bind(null, 'es'), translate.mensaje('spanish'), lang.bind(null, 'en-US'), translate.mensaje('english'));
...
//mejorar los modules
var el = yo(_templateObject, translate.mensaje('logout'));

//midleware para exportar el header vaciando el anterior (empty) y agregando
//next para el siguiente middleware
...
module.exports = function (pictures) {
	var element = yo(_templateObject, onsubmit, translate.mensaje('upload-picture'), onchange, translate.mensaje('upload'), cancel, pictures.map(function (pic) {
		return picture(pic);
	}));
...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yo(_templateObject, picture.liked ? 'liked' : '', picture.url, picture.user.username, picture.user.avatar, picture.user.username, translate.date.format(picture.createdAt), like.bind(null, true), like.bind(null, false), translate.mensaje('likes', { likes: picture.likes }));
  }
...
//utilizar yo-yo
//module.exports =Se le sdigna lo que tenga yo-yo, variable de JS, dividir en modulos o archivos con diferentes responnsabilidades
var signinForm = yo(_templateObject, translate.mensaje('signup.facebook'), translate.mensaje('signup.text'), translate.mensaje('username'), translate.mensaje('password'), translate.mensaje('signin-entrar'), translate.mensaje('signin.not-have-account'), translate.mensaje('signup.call-to-action'));
...
//utilizar yo-yo
//module.exports =Se le sdigna lo que tenga yo-yo, variable de JS, dividir en modulos o archivos con diferentes responnsabilidades
var signupForm = yo(_templateObject, translate.mensaje('signup-subheading'), translate.mensaje('signup.facebook'), translate.mensaje('signup.text'), translate.mensaje('email'), translate.mensaje('fullname'), translate.mensaje('username'), translate.mensaje('password'), translate.mensaje('signup.call-to-action'), translate.mensaje('signup.have-account'), translate.mensaje('signin'));
...
module.exports = {
	...
	'english': 'Inglés',
	'spanish': 'Español',
	'signup-subheading': 'Registrate para ve la foto de tus amigos estudiando en platzi',
	...
	'language': 'Idioma',
	'signin-entrar': 'Iniciar Sesión',
	'upload-picture': 'Subir Foto',
	'upload': 'Subir'
};
//''texto que s emuestra en el label
//0 me gusta
//1 me gusta
//2 me gusta
...
module.exports = {
		mensaje: function mensaje(message) {
